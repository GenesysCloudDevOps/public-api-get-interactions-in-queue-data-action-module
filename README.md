A Terraform/CX as Code remote module for the following Genesys Cloud public API operation: Get Interactions In Queue
...
```hcl
module "data_action" {
    source             = "git::https://github.com/GenesysCloudDevOps/public-api-get-interactions-in-queue-data-action-module.git?ref=v1.0.0"
    action_name        = "Get Interactions In Queue"
